...
void afficheElement(Element e){
	printf("%s",e.Name); printf(" ");
	printf("%s",e.Album); printf(" ");
	printf("%s",e.Artist); printf(" ");
	printf("%s",e.Genre); printf(" ");
	printf("%i",e.DiscNumber); printf(" ");
	printf("%i",e.TrackNumber); printf(" ");
	printf("%i",e.Year); printf(" ");
	printf("\n");
}
